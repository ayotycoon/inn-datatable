...
import { DataTableTypes } from '../lib/index';
...
export class AppComponent implements OnInit {
  ...
  dataTable = {
    ...
    heads: <DataTableTypes.Head[]>[
      ...
      {
        title: 'createdDate', key: 'createdDate', transform: (fieldData, rowData) => new Date(fieldData).toLocaleDateString(),

        type: 'date', html: (fieldData) => {
  ...
  ngOnInit() {
    ...
    this.getData()
      ...
      .then((data: any) => {
        this.dataSource = data.map((_, i) => { return { ..._, createdDate: Number(new Date), nested: { gender: 'male' } } });
